...
for czi_file in czi_files:
    ...
    # Save results.
    results.append({"file_name" : czi_file, "Mean Intensity" : MFI, "channel": channel_index + 1}) #dictionary, link index with a string...
    n += 1
print(" Finished.")
...
csv_columns = ['file_name', 'Mean Intensity', 'channel']
